...
const SpotlightDigDownCard = ({ productData, storeName }) => {
  return (
    <Link
    ...
    >
      <div className="flex gap-3 items-center">
        ...
        >
          ...
          <span className="font-semibold text-[#6355ff]">
      ...
      >
        ...
        <button
          type="button"
          className="w-full bg-gradient-to-b from-blue-50 to-blue-100 rounded-md py-3 font-bold"
        >
          {productData.buttonText}
        </button>
        <button
          type="button"
          className={` ${productData.style == "callout" && "hidden"} text-sm text-[#6355ff]"`}
        >
          Learn More
        </button>
      </div>
...
export default SpotlightDigDownCard;
