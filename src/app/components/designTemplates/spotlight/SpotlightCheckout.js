...
const SpotlightCheckout = ({ productData }) => {
    ...
    <div className="w-full grid grid-cols-1 lg:flex lg:gap-6 gap-2 h-screen">
      ...
      <div className="col-span-2 pr-[5%] px-[5%] py-[5%] md:ml-[25%] lg:ml-[30%]">
        ...
        <div className="w-full mt-4">
          ...
          <button
            type="button"
            className="w-full bg-gradient-to-b from-blue-50 to-blue-100 rounded-md py-3 font-bold mt-5"
          >
...
export default SpotlightCheckout;
