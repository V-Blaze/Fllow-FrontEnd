...
const KelsCheckout = ({ productData }) => {
    ...
    <div className="w-full grid grid-cols-1 lg:flex lg:gap-6 gap-2 h-screen px-4 py-2">
      ...
      <div className="col-span-2 pr-[5%] px-[5%] py-[5%] md:ml-[25%] lg:ml-[30%]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="font-semibold text-xl text-[#e0b6f4]">
            ${productData.hasDiscount && productData.discoutPrice}
            {productData.hasDiscount ? (
              <span className="text-[#e0b6f4]/50 line-through mx-2">
                {productData.price}
              </span>
            ) : (
              productData.price
        ...
        <div className="w-full mt-4">
          ...
          <div className="flex flex-col my-4 gap-5 w-full">
            <input
              type="text"
          ...
          <button
            type="button"
            className="w-full bg-[#e0b6f4] text-white rounded-md py-3 font-bold mt-5"
          >
