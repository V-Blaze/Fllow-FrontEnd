...
const FllowClassicURLCard = ({ productData }) => {
  return (
    <Link
      href=""
      className={`bg-white border-[1px] border-[#5383FF] rounded-lg p-4 flex flex-col gap-8 w-full h-fit ${productData.style == "callout" && "cursor-default"}`}
    >
...
export default FllowClassicURLCard;
