...
const EclipseCheckout = ({ productData }) => {
  const router = useRouter();
  return (
    <div className="w-full grid grid-cols-1 lg:flex lg:gap-6 gap-0 h-screen" style={{ background: 'linear-gradient(to bottom, #9B00FF, #4B00FF)', width: '100%', padding: '4%' }}>
        ...
        <div className="w-full mt-4">
          ...
          <div className="flex flex-col gap-5 w-full my-4">
            <input
              ...
              className="w-full text-[16px] text-[#d6d1d1] outline-none border-none focus:outline-none py-4 px-2 rounded-3xl bg-[#EEF1F5] "
            />
            <input
              type="text"
          ...
          <button
            type="button"
            className="w-full bg-[#EEF1F5] text-black rounded-3xl py-3 font-bold mt-5"
          >
...
export default EclipseCheckout;
