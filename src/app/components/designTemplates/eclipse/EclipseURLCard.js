...
const EclipseURLCard = ({ productData }) => {
  return (
    <Link
      href=""
      className={`bg-[#8000FF] border-[1px] border-[#9A44FF] rounded-lg p-4 flex flex-col gap-8 w-full h-fit ${productData.style == "callout" && "cursor-default"}`}
    >
