...
const ModernoCheckout = ({ productData }) => {
  const router = useRouter();
  return (
    <div className="w-full grid grid-cols-1 lg:flex lg:gap-6 gap-2 h-screen px-4 py-2">
      <div className="hidden md:flex flex-col justify-center items-center lg:h-screen lg:max-w-[50%] lg:fixed col-span-1  md:px-[5%] py-[5%]">
        <ModernoProfileCard />
      </div>
      <div className="col-span-2 pr-[5%] px-[5%] py-[5%] md:ml-[25%] lg:ml-[30%]">
        ...
        <div className="w-full mt-4">
          ...
          <button
            type="button"
            className="w-full bg-[#5383FF] text-white rounded-md py-3 font-bold mt-5"
          >
...
export default ModernoCheckout;
